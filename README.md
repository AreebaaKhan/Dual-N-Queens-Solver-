...
🎮 How to Use
1. Select N (4, 6, 8, 10, 12)  ← Board size
2. [Generate]                  ← Random starting board
3. [Run A*]                    ← A* search from random state
4. [Run CSP]                   ← CSP builds solution column-by-column
